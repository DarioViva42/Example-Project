...
public class PartsFactoryPresenter extends AbstractPresenter implements Serializable, HasLogger {
	private static final long serialVersionUID = -4584424067040090442L;

	private PartsFactoryView view;

	private final transient PartsSearchService searchService;

	@Autowired
	PartsFactoryPresenter(PartsSearchService searchService) {
		this.searchService = searchService;
	}

	void init(PartsFactoryView view) {
		this.view = view;
