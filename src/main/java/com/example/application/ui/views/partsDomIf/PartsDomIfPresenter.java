...
public class PartsDomIfPresenter extends AbstractPresenter implements Serializable, HasLogger {
	private static final long serialVersionUID = -4584424067040090442L;

	private PartsDomIfView view;

	private final transient PartsSearchService searchService;

	@Autowired
	PartsDomIfPresenter(PartsSearchService searchService) {
		this.searchService = searchService;
	}

	void init(PartsDomIfView view) {
		this.view = view;
